...
with open("/home/tmalik6/Summer/dedup/groq_api.txt", "r") as f:
...
run_eval(
    ...
    "EXP1 GSM8K (Llama8B)", "GSM8K_l70_binary_eval_exp1_llama8b.csv",
)
...
run_eval(
    ...
    "EXP1 MATH500 (Llama8B)", "MATH500_l70_binary_eval_exp1_llama8b.csv",
)
...
run_eval(
    ...
    "EXP2 GSM8K (Gemma2-9B self)", "GSM8K_l70_binary_eval_exp2_gemma2_9b.csv",
)
...
run_eval(
    ...
    "EXP2 MATH500 (Gemma2-9B self)", "MATH500_l70_binary_eval_exp2_gemma2_9b.csv",
)
...
run_eval(
    ...
    "EXP3 GSM8K (Llama3.3-70B)", "GSM8K_l70_binary_eval_exp3_llama70b.csv",
)
...
run_eval(
    ...
    "EXP3 MATH500 (Llama3.3-70B)", "MATH500_l70_binary_eval_exp3_llama70b.csv",
)
...
run_eval(
    ...
    "TARGET GSM8K (gold solution)", "GSM8K_l70_binary_eval_target.csv",
    solution_col="Target",
)
...
run_eval(
    ...
    "TARGET MATH500 (gold solution)", "MATH500_l70_binary_eval_target.csv",
    solution_col="Target",
)