...
# Experiment 1: Judge Llama-3.1-8B's own response
...
# Experiment 2: Judge Gemma-2-9B's response
...
run_eval(
    ...
    "EXP1 GSM8K (Llama8B self)", "GSM8K_l8_binary_eval_exp1_llama8b.csv",
)
...
run_eval(
    ...
    "EXP1 MATH500 (Llama8B self)", "MATH500_l8_binary_eval_exp1_llama8b.csv",
)
...
run_eval(
    ...
    "EXP2 GSM8K (Gemma2-9B)", "GSM8K_l8_binary_eval_exp2_gemma2_9b.csv",
)
...
run_eval(
    ...
    "EXP2 MATH500 (Gemma2-9B)", "MATH500_l8_binary_eval_exp2_gemma2_9b.csv",
)
...
run_eval(
    ...
    "EXP3 GSM8K (Llama3.3-70B)", "GSM8K_l8_binary_eval_exp3_llama70b.csv",
)
...
run_eval(
    ...
    "EXP3 MATH500 (Llama3.3-70B)", "MATH500_l8_binary_eval_exp3_llama70b.csv",
)